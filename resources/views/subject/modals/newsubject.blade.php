            ...
            <div class="modal-body">
                ...
                <strong>{{ $errors->first('section') }}</strong>
                        ...
                        <div class="form-group{{ $errors->has('sub_section') ? ' has-error' : '' }}">
                            ...
                            <select name="sub_section" class="form-control" >
                            	<option value=""></option>
                ...
                <strong>{{ $errors->first('sub_section') }}</strong>
                        ...
                        @else
                        <input type="hidden" value="0" name="sub_section">
                        @endif
                        </div>
                    <div class="modal-footer">
                        <input type="submit" value="Add Subject" id="saveStd" class="btn btn-primary">
